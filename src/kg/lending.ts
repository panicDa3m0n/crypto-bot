...
export class BorrowerPositionSim {
  ...
  /** Exact liquidatability (no float): collateral · price · lltv < debt · 1e54. */
  liquidatable(m: LendingMarketSim): boolean {
    if (this.debtAssets <= 0n || this.collateral <= 0n) return false;
