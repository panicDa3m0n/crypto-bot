...
export const networkSchema = z.object({
  ...
  rpc: z.object({ primary: z.string().url(), secondary: z.string().url(), ws: z.string().optional(), precision: z.string().url().optional(), fallback: z.string().url().optional(), execution: z.string().url().optional(), bulk: z.string().url().optional() }),
